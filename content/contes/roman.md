...
<div class="small">NOTA. Aquesta història no ha estat generada mitjançant ChatGPT, sinó amb un procediment fins a cert punt anàleg: llegir molt, tota mena de coses; mirar d’assimilar el que llegeixes; remesclar-ho d’una manera que puga parèixer original i interessant, si més no per a tu mateix.</div>